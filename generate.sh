...
asciidoctor-pdf -a pdf-style=./themes/theme.yml -a lang=en -o dist/en/index.pdf index.adoc
asciidoctor-pdf -a pdf-style=./themes/theme.yml -a lang=fr -o dist/fr/index.pdf index.adoc
